...
final class Version20260418103100 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Normalizes SQLite schema for intake templates and field linkage';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TEMPORARY TABLE __temp__ticket_intake_templates AS SELECT id, category_id, name, description, request_type, customer_type, is_active, created_at, updated_at FROM ticket_intake_templates');
        ...
        $this->addSql('INSERT INTO ticket_intake_templates (id, category_id, name, description, request_type, customer_type, is_active, created_at, updated_at) SELECT id, category_id, name, description, request_type, customer_type, is_active, created_at, updated_at FROM __temp__ticket_intake_templates');

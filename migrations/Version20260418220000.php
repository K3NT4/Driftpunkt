...
final class Version20260418220000 extends AbstractMigration
{
    ...
    {
        return 'Adds last polled timestamp for support mailboxes';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('ALTER TABLE support_mailboxes ADD last_polled_at DATETIME DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('CREATE TEMPORARY TABLE __temp__support_mailboxes AS SELECT id, company_id, incoming_server_id, default_category_id, default_team_id, name, email_address, default_priority, polling_interval_minutes, allow_unknown_senders, create_draft_tickets_for_unknown_senders, allow_attachments, is_active, created_at, updated_at FROM support_mailboxes');
        ...
        $this->addSql('INSERT INTO support_mailboxes (id, company_id, incoming_server_id, default_category_id, default_team_id, name, email_address, default_priority, polling_interval_minutes, allow_unknown_senders, create_draft_tickets_for_unknown_senders, allow_attachments, is_active, created_at, updated_at) SELECT id, company_id, incoming_server_id, default_category_id, default_team_id, name, email_address, default_priority, polling_interval_minutes, allow_unknown_senders, create_draft_tickets_for_unknown_senders, allow_attachments, is_active, created_at, updated_at FROM __temp__support_mailboxes');
        ...
        $this->addSql('DROP TABLE __temp__support_mailboxes');
    }
}
